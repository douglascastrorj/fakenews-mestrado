...
print('TREINANDO BERT')
BERT_MODEL =  'bert-base-multilingual-cased' # 'neuralmind/bert-base-portuguese-cased'  #'n
...
for i in range(0, NUM_EXPERIMENTS):
    ...
    torch.save(model.state_dict(), 'models/'+BERT_MODEL+'-'+datetime.now().strftime("%Y-%m-%dT%H:%M")+'.model')
